...
- Practical recommendations for QC and analysis of whole-genome and exome sequencing. Resources ([gnomAD](https://gnomad.broadinstitute.org/), [Bravo variant browser](https://bravo.sph.umich.edu/)), pipelines ([RICOPILI pipeline](https://sites.google.com/a/broadinstitute.org/ricopili/)). Description of tools for conducting QC (PLINK, VCFtools, bcftools, [vcfexpress](https://github.com/brentp/vcfexpress), [Hail](https://hail.is/)). Filters description and recommendations for filtering (low complexity regions, LD pruning). Individual variant filters include the phred-scaled likelihood of the genotype (remove PL<20), Genotype quality (remove GQ<20), Allele balance (remove AB<0.2-0.25), changing them depending on sequencing depth. Table 2 - Hail commands for variant filtering. Sample filtering, e.g., insufficient read depth, call rate, contamination ([CHARR](https://doi.org/10.1101/2023.06.28.545801)), chimeric read rate, excessive relatedness (Hail's identity_by_descent() and similar commands), Ti/Tv ratio (expected 3-3.3 for coding and 2 for whole genome), proportions of variant types (indels are much less common). Variant Quality Score Recalibration and reapplication of the filters. Visualization of QC metrics is critical. [GitHub](https://github.com/jsealock1/sequencing_qc) repo for conducting quality filtering on variants and samples from WES in Hail. <details>
    <summary>Paper</summary>
    Sealock, Julia M., Franjo Ivankovic, Calwing Liao, Siwei Chen, Claire Churchhouse, Konrad J. Karczewski, Daniel P. Howrigan, and Benjamin M. Neale. “Tutorial: Guidelines for Quality Filtering of Whole-Exome and Whole-Genome Sequencing Data for Population-Scale Association Analyses.” Nature Protocols, March 28, 2025. https://doi.org/10.1038/s41596-025-01169-1.
</details>
